...
// Raw: Para escrever uma condição apra o campo date no formato texto passado direto para o postgres, como fosse uma query

import IAppointmentRepository from '@modules/appointments/repositories/IAppointmentsRepository';
import ICreateAppointmentDTO from '@modules/appointments/dtos/ICreateAppointmenstsDTO';
